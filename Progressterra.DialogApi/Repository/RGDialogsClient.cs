...
namespace Progressterra.DialogApi.Repository
{
    public class RGDialogsClients
    {
        ...
        public static List<RGDialogsClients> Init()
        {
            ...
            Guid IDRGDialog1 = new("fcd6b112-1834-4420-bee6-70c9776f6378");
            ...
            Guid IDRGDialog2 = new("19f6f751-7f8d-41fa-8261-709028650592");
            L1.Add(new RGDialogsClients
            {
                IDUnique = Guid.NewGuid(),
            ...
            Guid IDRGDialog3 = new("83ebeb2b-c315-48a2-b6e5-f0324de57a9f");
            L1.Add(new RGDialogsClients
            {
                IDUnique = Guid.NewGuid(),
